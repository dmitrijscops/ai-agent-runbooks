...
│   ├── 3.Runbook.md
│   └── 4.Sample-prompts.md
├── 📂 IT-Service-Desk-Insights-Agent/      ← Read-only Agent Builder
│   ├── 📂 0.Resources/
│   ├── 1.Overview.md
│   ├── 2.Architecture.md
│   ├── 3.Runbook.md
│   └── 4.Sample-prompts.md
├── 📂 IT-Service-Desk-Insights-Agent-ghcp/ ← GitHub Copilot harness in Copilot Studio
│   ├── 📂 0.Resources/
│   ├── 1.Overview.md
│   ├── 2.Architecture.md
│   ├── 3.Runbook.md
...
| [IT-Service-Desk-Insights-Agent](./IT-Service-Desk-Insights-Agent/) | IT Service Management / Knowledge Support | Read-only knowledge and catalog answers with permission trimming, citations, multilingual support, and consistency checks. No live incident tools or record actions. | Microsoft 365 Copilot, Agent Builder, ServiceNow Knowledge + Catalog Copilot connectors | Implementation guide available; tenant configuration required |
| [IT-Service-Desk-Insights-Agent-ghcp](./IT-Service-Desk-Insights-Agent-ghcp/) | IT Service Management / Investigation and Resolution | Separate investigation/resolution blueprint with a capability matrix and 17 agent-scoped skills for ServiceNow, Nexthink, and Dynamics Customer Service. Backend-owned routing; requester-only closure. | Copilot Studio GitHub Copilot harness, ServiceNow, Nexthink APIs, Dataverse, Office 365 Users | Documentation and skills available; tenant implementation required |
